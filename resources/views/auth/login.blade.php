				...
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<br/>
                            <a href="{{ url('/') }}" >
							<span class="text-lg text-bold text-primary"><span class="text-danger">LOGIN</span> - DAILY ACTIVITY</span>
                                </a >
							<br/><br/>
							<form class="form floating-label form-validate"  novalidate="novalidate" action="{{ url('/login') }}" accept-charset="utf-8" method="post">
                                {{ csrf_field() }}
								...
								<div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
									<input type="password" class="form-control" data-rule-minlength="6" id="password" name="password" required>
						...
						<div class="col-sm-5 col-sm-offset-1 text-center">
							<br><br>
								...
								<br><br>
									...
									<p>
										<a href="{{ url('auth/facebook') }}" class="btn btn-block btn-raised btn-info"><i class="fa fa-facebook pull-left"></i>Login with Facebook</a>
									</p>
									<p>
