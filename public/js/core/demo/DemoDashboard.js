		...
		var data = [
			{
				label: 'Activity',
				data: [
					[moment().subtract(13, 'month').valueOf(), 20],
					[moment().subtract(12, 'month').valueOf(), 10],
					[moment().subtract(11, 'month').valueOf(), 10],
					[moment().subtract(10, 'month').valueOf(), 4],
					[moment().subtract(9, 'month').valueOf(), 3],
					[moment().subtract(8, 'month').valueOf(), 2],
					[moment().subtract(7, 'month').valueOf(), 3],
					[moment().subtract(6, 'month').valueOf(), 5],
					[moment().subtract(5, 'month').valueOf(), 3],
					[moment().subtract(4, 'month').valueOf(), 4],
					[moment().subtract(3, 'month').valueOf(), 6],
					[moment().subtract(2, 'month').valueOf(), 5],
					[moment().subtract(1, 'month').valueOf(), 6],
					[moment().valueOf(), 8]
				],
				last: true
			}
